...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle("FouBar FX");
        this.primaryStage.getIcons().add(new Image("img/icons8-cocktail-64.png"));

        initRootLayout();

        //showPersonOverview();
        if(Authentification()) showPersonOverview();
    }
    ...
    private boolean Authentification() {
        ...
        try {
            ...
            AnchorPane authentification = (AnchorPane) loader.load();

            // Set person overview into the center of root layout.
            rootLayout.setCenter(authentification);

            // Give the controller access to the main app.
            LoginController controller = loader.getController();
            controller.setMainApp(this);
            //isExisting = controller.exist();
